        ...
        <div class="col-md-3">
            <div class="card shadow text-center">
                <div class="card-body">
                    ...
                    <a href="novo_tecnico.php" class="btn btn-success">
                        Novo Técnico
                    </a>
        ...
        <div class="col-md-3">
            <div class="card shadow text-center">
                <div class="card-body">
                    ...
                    <a href="listar_tecnico.php" class="btn btn-primary">
                        Consultar
                    </a>
        ...
        <div class="col-md-3">
            <div class="card shadow text-center">
                <div class="card-body">
                    ...
                    <a href="listar_tecnico.php" class="btn btn-warning">
                        Alterar
                    </a>
        ...
        <div class="col-md-3">
            <div class="card shadow text-center">
                <div class="card-body">
                    ...
                    <a href="listar_tecnico.php" class="btn btn-danger">
                        Excluir
                    </a>
