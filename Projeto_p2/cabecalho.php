                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="cadastrosDropdown">
                            ...
                            <li>
                                <a class="dropdown-item" href="Cadastros/equipamentos.php">
                                    <i class="bi bi-cpu"></i>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="manutencaoDropdown">
                            ...
                            <li>
                                <a class="dropdown-item" href="nova_manutencao.php">
                            ...
                            <li>
                                <a class="dropdown-item" href="manutencoes.php">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="relatoriosDropdown">
                            ...
                            <li>
                                <a class="dropdown-item" href="relatorio_equipamentos.php">
                                    <i class="bi bi-cpu"></i>
                            ...
                            <li>
                                <a class="dropdown-item" href="relatorio_tecnicos.php">
                                    <i class="bi bi-person-gear"></i>
                            ...
                            <li>
                                <a class="dropdown-item" href="relatorio_manutencoes.php">
                                    <i class="bi bi-tools"></i>
